            ...
            <div class="block">
                ...
                <form action="{{url('setornilaipenguji/'.$data->nim)}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input readonly class="form-control" name="" value="" placeholder="{{$yangke3->jumlah_A}}">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input readonly class="form-control" name="" value="" placeholder="{{$yangke3->jumlah_B}}">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input readonly class="form-control" name="" value="" placeholder="{{$yangke3->jumlah_C}}">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input readonly class="form-control" name="" value="" placeholder="{{$yangke3->jumlah_D}}">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input readonly class="form-control" name="" value="" placeholder="{{$yangke3->jumlah_E}}">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input readonly class="form-control" name="" value="" placeholder="{{$yangke3->jumlah_F}}">
                            <span class="text-danger"></span>
                        </div>
                    </div>
