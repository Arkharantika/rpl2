    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="js-wizard-validation-classic block">
                ...
                <form method="post" action="{{url('ubah2c/'.$idnya)}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="tab-pane active" id="wizard-validation-classic-step1" role="tabpanel">
                            ...
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Jenis Pendidikan / Pelatihan
                                    Kerja Formal :</label>
                                <textarea type="form-control" class="form-control" placeholder="{{$datanya->jenis_pendidikan}}" name="jenis"
                            ...
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Materi Pendidikan / Pelatihan
                                    Kerja Formal :</label>
                                <textarea type="form-control" class="form-control" placeholder="{{$datanya->materi}}" name="materi"
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="form-control" class="form-control" placeholder="{{$datanya->lamanya}}" name="lama" id="lama"
                                    required></textarea>
                            </div>
                            <div class="form-group">
