...
<div class="content">
    ...
    <h2 class="content-heading">Dosen Penguji</h2>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="js-wizard-validation-classic block">
                ...
                <ul class="nav nav-tabs nav-tabs-block nav-fill" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#wizard-validation-classic-step4" data-toggle="tab">Dosen Penguji Online dan Wawancara</a>
                    </li>
                </ul>
                <!-- END Step Tabs -->

                <!-- Form -->
                <form class="js-wizard-validation-classic-form" action="{{ url('paraPenguji') }}" method="post">
                @csrf
                    <!-- Steps Content -->
                    <div class="block-content block-content-full tab-content" style="min-height: 265px;">
                        ...
                        <div class="tab-pane active" id="wizard-validation-classic-step1" role="tabpanel">
                            ...
                            <input type="hidden" class="form-control" value="SETUJU" name="status_ta">
                            <input type="hidden" class="form-control" value="0" name="cetak_ta">
                            <input type="hidden" class="form-control" value="1" name="rpl">
                            <div class="form-group row">
                        ...
                        <div class="tab-pane" id="wizard-validation-classic-step4" role="tabpanel">
                            <?php for ($i = 1; $i <= 3; $i++) { ?>
                            <div class="form-group">
                                <label for="sks">Penguji Online {{$i}}  <span class="text-danger">*</span></label>
                                <select class="form-control js-select2" style="width: 100%" name="pembimbing{{$i}}" id="pembimbing{{$i}}">
                            ...
                            <?php for ($i = 1; $i <= 3; $i++) { ?>
                            <div class="form-group">
                                <label for="sks">Penguji Wawancara {{$i}} <span class="text-danger">*</span></label>
                                <select  class="form-control js-select2" style="width: 100%" name="pengujiwawancara{{$i}}" id="pembimbing{{$i}}">
                                    <option value="">Pilih Pembimbing</option>
                                    @foreach ($dosen as $dosens)
                                        <option name="dosen" value="{{ $dosens->id }}" {{old('pembimbing'.($i)) == $dosens->id ? 'selected' : ''}}>{{ $dosens->nama_dosen}}</option>
                                    @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                ...
                                <button type="submit" class="btn btn-alt-primary d-none" data-wizard="finish">
                                    <i class="fa fa-check mr-5"></i> Set Penguji !
                                </button>
                            </div>
                        </div>
                    </div>
