            ...
            <div class="js-wizard-validation-classic block">
                ...
                <ul class="nav nav-tabs nav-tabs-block nav-fill" role="tablist">
                    <li class="nav-item">
                        ...
                        <h3 class="mt-10">Pengajar / Pelatih / Instruktur / Dosen Tamu pada pembelajaran atau pelatihan
                            keinsinyuran</h3>
                    </li>
                </ul>
                <!-- END Step Tabs -->

                <form method="post" action="{{url('ubah5d/'.$idnya)}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="block-content block-content-full tab-content" style="min-height: 265px;">
                        ...
                        <div class="tab-pane active" id="wizard-validation-classic-step1" role="tabpanel">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="form-control" class="form-control" placeholder="{{$datanya->jenis}}" name="judul"
                            ...
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Jumlah Peserta
                                    :</label>
                                <textarea type="form-control" class="form-control" placeholder="{{$datanya->jumlah}}" name="kedudukan"
                                    id="kedudukan" required></textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Lamanya Kegiatan Instruktur
                                    (Jam) :</label>
                                <textarea type="form-control" class="form-control" placeholder="{{$datanya->lamanya}}"
                                    name="kedudukan_penulisan" id="kedudukan_penulisan" required></textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Link G-Drive Surat tugas
                                    :</label>
