            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-di">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell text-center font-size-sm text-center">{{$row['created_at']}}
                        </td>
                        ...
                        <a href="{{route('dosen.undangan.semhas', $row->ta_id)}}" class="btn btn-sm btn-alt-warning mr-5 mb-5" target="_blank"><i class="fa fa-print"></i> Undangan</a> -->
                            <a href="{{route('dosen.nilai_semhas.show', $row->ta_id)}}"
                                class="btn btn-sm btn-alt-danger mr-5 mb-5"><i class="fa fa-edit"></i> Nilai</a>

                            <a href="{{url('pembimbing/cetakprofilpenguji', $row->nim)}}"
                            ...
                            <a href="{{url('pembimbing/dataprofilpenguji', $row->nim)}}"
                            ...
                            @endif
                            @else
                            <a href="{{route('dosen.semhas.edit', $row->ta_id)}}"
                                class="btn btn-sm btn-alt-warning mr-5 mb-5"><i class="fa fa-edit"></i> Update</a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            <a href="{{url('pengujianwawancara',$row->ta_id)}}" class="btn btn-sm btn-alt-danger mr-5 mb-5"><i class="fa fa-edit"></i> Nilai</a>
