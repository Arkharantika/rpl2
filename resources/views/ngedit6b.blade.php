    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="js-wizard-validation-classic block">
                ...
                <form method="post" action="{{url('ubah6b/'.$idnya)}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="block-content block-content-full tab-content" style="min-height: 265px;">
                        ...
                        <div class="tab-pane active" id="wizard-validation-classic-step1" role="tabpanel">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="form-control" class="form-control" placeholder="{{$datanya->nama_organisasi}}" name="judul"
                            ...
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Link G-Drive Sertifikat/surat
                                    ...
                                    :</label>
                                <textarea type="form-control" class="form-control" placeholder="{{$datanya->jadwal}}" name="sertifikat"
