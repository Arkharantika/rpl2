...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="js-wizard-validation-classic block">
                ...
                <!-- Form -->
                <form class="js-wizard-validation-classic-form" action="PresensiSeminarHasil" method="post">
                @csrf
                    <!-- Steps Content -->
                    <div class="block-content block-content-full tab-content" style="min-height: 265px;">
                        ...
                        <div class="tab-pane active" id="wizard-validation-classic-step1" role="tabpanel">
                            ...
                            <!-- <div class="form-group">
                                <label for="sks">Judul Seminar Hasil <span class="text-danger"></span></label>
    ...
    <div class="block">
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title">List Kehadiran Seminar Hasil</h3>
        </div>
